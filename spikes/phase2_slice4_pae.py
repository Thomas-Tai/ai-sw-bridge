...
try:
    result_a = part_build(BOX_SPEC, save_as=PART_A_PATH, save_format="current", no_dim=True)
...
try:
    result_b = part_build(BOX_SPEC, save_as=PART_B_PATH, save_format="current", no_dim=True)
    ...
    "mates": [
        {
            ...
            "b": {
                "component": "box_b",
                "face_ref": face_b_bottom or {"normal": [0, 0, -1], "centroid": [0, 0, 0]},
            },
        },
        {
            "type": "parallel",
            "a": {
                "component": "box_a",
                "face_ref": face_a_right or {"normal": [1, 0, 0], "centroid": [15, 0, 5]},
            },
            "b": {
                "component": "box_b",
                "face_ref": face_b_right or {"normal": [1, 0, 0], "centroid": [15, 0, 5]},
            },
        },
