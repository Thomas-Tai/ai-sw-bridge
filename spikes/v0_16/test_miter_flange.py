"""Test: Miter flange with more parameter combinations."""
import sys
...
try:
    ...
    # Try different parameter counts
    tests = [
        ("7 params", (0.001, 1, 0.001, False, 0.0, 0.001, 0)),
        ("8 params", (0.001, 1, 0.001, False, 0.0, 0.001, 0, 0)),
        ("9 params", (0.001, 1, 0.001, False, 0.0, 0.001, 0, 0, 0)),
        ("10 params", (0.001, 1, 0.001, False, 0.0, 0.001, 0, 0, 0, 0)),
        ("11 params", (0.001, 1, 0.001, False, 0.0, 0.001, 0, 0, 0, 0, 0)),
    ]
    ...
    for name, params in tests:
        ...
        print(f"=== {name} ===")
        try:
            feat2 = fm.InsertSheetMetalMiterFlange(*params)
            if feat2:
