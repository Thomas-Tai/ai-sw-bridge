...
def main():
    ...
    print(f"box bbox: x=[{bb[0]*1000:.0f},{bb[3]*1000:.0f}] z=[{bb[2]*1000:.0f},{bb[5]*1000:.0f}]")
    ...
    print(f"after hole: bbox x=[{bb2[0]*1000:.0f},{bb2[3]*1000:.0f}] z=[{bb2[2]*1000:.0f},{bb2[5]*1000:.0f}]")
    faces = doc.GetBodies2(0, True)[0].GetFaces()
    print(f"  face count: {len(faces)} (block has 6 faces; +1 cylinder side +1 hole bottom = 8 expected for blind hole)")
