...
def _fillet_adapter(doc: Any, feature: dict, target: dict) -> tuple[bool, str | None]:
...
def _varfil_adapter(doc: Any, feature: dict, target: dict) -> tuple[bool, str | None]:
