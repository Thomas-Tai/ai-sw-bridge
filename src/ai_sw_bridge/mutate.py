...
_SW_FM_SWEEP_CUT = 18
# swRefPlaneReferenceConstraints_e used by the edge_flange island (_build_edge_normal_plane_sketch).
# Distance=8 (_SW_REFPLANE_OFFSET) was moved to features/ref_geometry.py with the ref-plane handler.
