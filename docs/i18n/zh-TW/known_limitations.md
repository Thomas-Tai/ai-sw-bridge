...
三種失敗的抑制方法記載於 [spikes/phase0/MMP_DEBUG_SESSION.md](../../../spikes/phase0/MMP_DEBUG_SESSION.md) 以及實驗 M 和 O 中：
...
- 完全繞過 AddDimension2，改用可查詢的內部 SW 尺寸（實驗 O）— SW 不會自動建立可連結的尺寸物件
